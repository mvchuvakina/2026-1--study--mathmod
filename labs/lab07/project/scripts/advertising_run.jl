# scripts/advertising_run.jl
# Модель распространения рекламы (вариант №56)
...
p1 = plot(sol1, idxs=1, label=L"n(t)", linewidth=2,
          ...
          title="Случай 1: Платная реклама доминирует (α₁=0.68, α₂=0.00009)")

# -------------------------------------------------------------------
# СЛУЧАЙ 2: α₁ = 0.00001, α₂ = 0.28
# -------------------------------------------------------------------
...
p2 = plot(sol2, idxs=1, label=L"n(t)", linewidth=2,
          xlabel="Время t, дни", ylabel="Число знающих n(t)",
          title="Случай 2: Сарафанное радио доминирует (α₁=0.00001, α₂=0.28)")
...
# -------------------------------------------------------------------
println("\n3. ТОЛЬКО ПЛАТНАЯ РЕКЛАМА (без сарафанного радио)")
...
# -------------------------------------------------------------------
println("4. ТОЛЬКО САРАФАННОЕ РАДИО (без платной рекламы)")
